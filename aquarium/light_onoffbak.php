...
if(db->connect_error)
{
	...
	$insert = "insert into light_onoff(weekday_on1,weekday_on2,weekday_off1,weekday_off2,weekend_on1,weekend_on2,weekend_off1,weekend_off2) values($week_on1,$week_on_2,$week_off1,$week_off2,$weekend_on1,$weekend_on2,$weekend_off1,$weekend_off2)";
